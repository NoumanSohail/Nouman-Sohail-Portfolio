...
export const iconsmotion = [
  {
    Icon: Smartphone,
    className: "bg-blue-300/10 border-blue-300 text-blue-300",
  },
  {
    Icon: Code2,
    className: "bg-purple-300/10 border-purple-300 text-purple-300",
  },
  {
    Icon: Server,
    className: "bg-pink-300/10 border-pink-300 text-pink-300",
  },
  {
    Icon: Database,
    className: "bg-red-300/10 border-red-300 text-red-300",
  },
];
...
export const contactdata = [
  {
    ...
    content:
      "I’m always open to discussing new projects, freelance work, or full-time opportunities. Whether you have an idea, a question, or just want to say hi, feel free to reach out — I’ll get back to you as soon as possible.",
    mail: "noumansohail40@gmail.com",
    mobile: "+91 863 911 2756",
  },
];

export const footerdata = [
  {
    title: "© 2026 Mohammad Nouman Sohail. All rights reserved.",
    content: "Full Stack Mobile & Web Developer",
