...
export const aboutdata = [
  {
    id: 1,
    text: "I’m a Full Stack Mobile & Web Developer who enjoys building clean, scalable, and user-focused applications. I like working across the stack — from crafting responsive interfaces to designing reliable backend systems that grow with the product.",
  },
  {
    id: 2,
    text: "I primarily work with React, Next.js, React Native, Node.js, and Spring Boot, along with databases like MongoDB and MySQL. I have experience deploying and managing applications using AWS EC2 and Vercel, and I use Git for version control and collaborative development. I focus on writing maintainable code, improving performance, and paying attention to UI details that make applications feel smooth and intuitive.",
  },
  {
    id: 3,
    text: "Through internships and real-world projects, I’ve worked in Agile environments, built REST APIs, integrated databases, and delivered features used by real users. I’m always looking to learn, improve my craft, and contribute to products that solve meaningful problems.",
  },
];
