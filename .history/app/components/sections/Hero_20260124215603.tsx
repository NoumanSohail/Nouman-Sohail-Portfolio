...
const Hero = () => {
  return (
    ...
    >
      {/* Central Glowing Orb */}
      <div
        className="absolute pointer-events-none hidden lg:block lg:left-55 xl:left-0
                   w-[45%] h-[45%] bg-blue-700/50 rounded-full blur-[120px] opacity-10
                   animate-pulse [animation-delay:2000ms] z-0"
      />

      {/* Orbiting Elements */}
      <div
        className="absolute pointer-events-none hidden lg:block left-55
                   w-110 h-110 border border-white/5 rounded-full
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-7 lg:gap-20 text-center lg:text-start">
        <div className="flex flex-col gap-5">
          ...
          >
            <h1 className="font-black text-4xl lg:text-5xl xl:text-6xl tracking-wider text-balance text-transparent bg-clip-text bg-linear-to-r from-blue-400 via-purple-400 to-red-400">
          ...
          >
            ...
            <Button
              ...
              icon={<Download />}
              className="border border-white/30 backdrop-blur-xs bg-linear-to-r from-blue-400/20 via-purple-400/20 to-red-400/20 p-4 w-[70%] lg:w-[50%] rounded-full md:text-lg transition-all duration-300 hover:animate-bounce"
            />
          </motion.div>
        </div>
