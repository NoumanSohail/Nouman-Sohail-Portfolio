        ...
        <div className="flex flex-wrap items-center justify-center gap-10 w-fit pb-5">
          ...
          {projectsData.map((project, index) => (
            <motion.div
              ...
              className="flex flex-col gap-3 border border-white/20 bg-white/5 backdrop-blur-xs p-5
                         md:w-[84.5%] lg:w-[47.5%] xl:w-[41%] rounded-3xl transition-all duration-300
