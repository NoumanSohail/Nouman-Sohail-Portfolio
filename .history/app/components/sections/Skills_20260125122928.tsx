        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex flex-wrap gap-10 items-start justify-center p-10">
            {skillsData.map((skill, index) => (
              <div
                key={index}
                className="hover:rotate-3 hover:scale-105 hover:shadow-xl hover:shadow-orange-200/30 transition-transform duration-300 backdrop-blur-xs border bg-linear-to-r from-blue-400/20 via-purple-400/20 to-red-400/20 border-white/20 text-white p-5 rounded-3xl flex flex-col justify-center items-center gap-5"
              >
                <Image
                  src={skill.img}
                  className="h-30"
