...
const Hero = () => {
  return (
    ...
    >
      ...
      {/* Orbiting Elements */}
      <div className="absolute w-[600px] h-[600px] border border-white/5 rounded-b-full rounded-l-full rounded-b-3xl animate-spin [animation-duration:20s]" />
      <div className="absolute w-[400px] h-[400px] border border-white/10 rounded-full animate-spin [animation-duration:15s] [animation-direction:reverse]" />
