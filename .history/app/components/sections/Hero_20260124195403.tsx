...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative scroll-mt-40 w-full mx-auto max-w-384 px-5 md:px-10 lg:px-15 text-white mt-30 md:mt-40 z-10 overflow-hidden"
    >
      <div className="relative w-full h-full">
        {/* 🔮 Glowing Orb (UNDER the circle) */}
        <div
