        ...
        <div className="flex flex-col gap-5">
          ...
          >
            ...
            <Button
              ...
              icon={<Download />}
              className="border border-white/30 bg-linear-to-r from-blue-400/20 via-purple-400/20 to-red-400/20 p-4 w-[70%] lg:w-[50%] rounded-full md:text-lg transition-all duration-300"
            />
          </motion.div>
        </div>
