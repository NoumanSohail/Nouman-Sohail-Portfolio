...
const Hero = () => {
  return (
    <section id="home" className="scroll-mt-40 w-full mx-auto max-w-384 px-5 md:px-10 lg:px-15 text-white mt-30 md:mt-40 overflow-hidden">
      {/* Central Glowing Orb */}
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 
          w-[70vw] h-[70vw] sm:w-[45%] sm:h-[45%] bg-indigo-300 rounded-full 
          blur-[120px] opacity-40 animate-pulse [animation-delay:2000ms] z-0
        "
      />
