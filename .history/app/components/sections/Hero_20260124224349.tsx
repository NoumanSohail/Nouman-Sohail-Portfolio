    ...
    >
      ...
      <div
        className="absolute pointer-events-none
             -left-80 -top-80 w-44 h-44 xl:w-56 xl:h-56
             rounded-full
             bg-linear-to-br from-gray-600 via-gray-400 to-gray-200
             shadow-[0_0_120px_40px_rgba(100,100,100,0.25)]
             z-0"
      >
        {/* Moon texture */}
      ...
      <div className="relative flex flex-col lg:flex-row items-center justify-center gap-7 lg:gap-20 text-center lg:text-start mt-30 xl:mt-40">
