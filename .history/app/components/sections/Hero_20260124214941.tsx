        ...
        <div className="flex flex-col gap-5">
          ...
          >
            ...
            <Button
              ...
              className="border border-white/30 bg-white/20 hover:bg-linear-to-r from-blue-400 via-purple-400 to-red-400 p-4 w-[70%] lg:w-[50%] rounded-full md:text-lg transition-all duration-300"
            />
          </motion.div>
        </div>
