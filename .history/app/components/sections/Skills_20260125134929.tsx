        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex flex-wrap gap-10 items-start justify-center p-10">
            {skillsData.map((skill, index) => (
              <div
                key={index}
                className="hover:rotate-3 hover:scale-105 hover:shadow-md hover:shadow-purple-300/50 transition-transform duration-300 backdrop-blur-xs border bg-white/5 border-white/20 text-white p-5 rounded-3xl flex flex-col justify-center items-center gap-5"
              >
                <Image
                  src={skill.img}
                  className="h-30"
