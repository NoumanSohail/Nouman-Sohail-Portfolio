  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-10 mt-20 xl:mt-30">
        ...
        {/* Entire Content */}
        <div className="flex flex-col items-center justify-center gap-0 w-full pb-5">
          {experiencedata.map((experience, index) => (
            <div
              key={index}
              className="flex flex-col border-white/30 bg-white/5 p-5 w-full rounded-3xl border hover:scale-105"
            >
