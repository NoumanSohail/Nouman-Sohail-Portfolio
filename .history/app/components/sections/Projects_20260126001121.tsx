  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Projects Grid */}
        <div className="flex flex-wrap gap-10 w-full max-w-6xl">
          {projectsData.map((project, index) => (
            <div
              key={index}
              className="flex flex-col gap-5 border border-white/20 bg-white/5 w-130
                         backdrop-blur-xs rounded-3xl p-6 hover:scale-105 hover:shadow-md
            ...
            >
              ...
              {/* Description Points */}
              <ul className="list-disc list-inside text-gray-300 flex flex-col gap-2 ml-10">
