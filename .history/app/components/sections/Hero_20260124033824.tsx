...
const Hero = () => {
  return (
    <section
      id="home"
      className="w-full mx-auto max-w-384 px-5 md:px-10 lg:px-15 text-white"
    >
      <div className="flex flex-col lg:flex-row items-center justify-center gap-7 lg:gap-20 mt-35 text-center lg:text-start">
