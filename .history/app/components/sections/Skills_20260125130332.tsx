    ...
    >
      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex gap-10 items-start justify-between p-10">
            {skillsData.map((skill, index) => (
              <div
                key={index}
                className="hover:rotate-3 hover:scale-105 hover:shadow-md hover:shadow-purple-300/50 transition-transform duration-300 backdrop-blur-xs border bg-white/5 border-white/20 text-white p-5 rounded-3xl flex flex-col items-center justify-between gap-5"
              >
                <Image
                  src={skill.img}
                  className="h-30"
