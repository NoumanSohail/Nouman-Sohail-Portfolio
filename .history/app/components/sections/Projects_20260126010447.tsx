  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Content */}
        <div className="flex flex-wrap items-center justify-center gap-10 w-fit">
          {projectsData.map((project, index) => (
            <div
              key={index}
              className="flex flex-col gap-5 border border-white/20 bg-white/5 w-[90%] lg:w-[47.5%] xl:w-[41%]
            ...
            >
              ...
              {/* Tech Stack */}
              <p className="text-lg font-semibold text-purple-300">{project.stack}</p>
