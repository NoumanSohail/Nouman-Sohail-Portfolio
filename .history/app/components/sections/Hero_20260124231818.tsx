...
const Hero = () => {
  return (
    ...
    >
      {/* 🌙 Glowing Moon */}
      <div className="flex absolute rounded-full animate-pulse -left-15 -top-15 bg-white/30">
        <div
          className="absolute pointer-events-none w-44 h-44 xl:w-56 xl:h-56 
                   rounded-full bg-linear-to-br from-gray-600 via-gray-400 to-gray-200
                   shadow-[0_0_120px_40px_rgba(100,100,100,0.25)] z-0"
        >
          {/* Moon texture */}
