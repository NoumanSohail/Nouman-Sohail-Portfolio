...
const Hero = () => {
  return (
    ...
    >
      {/* Central Glowing Orb */}
      <div className="absolute left-1/2 -translate-x-1/2 -translate-y-1/2 w-[35%] h-[35%] bg-indigo-500 rounded-full blur-[120px] opacity-40 animate-pulse [animation-delay:600ms]" />
