      ...
      >
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="flex flex-wrap items-center justify-center p-10">
            {skillsData.map((skill, index)=>(
              <div key={index} className="flex flex-col items-center justify-center gap-10 border border-white/20 bg-white/5
                                          backdrop-blur-xs hover:rotate-3 hover:scale-105 hover:shadow-md
                                          hover:shadow-purple-300/50 text-white p-5 rounded-3xl "
              >
