      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-7 lg:gap-20 text-center lg:text-start">
        <div className="flex flex-col gap-5">
          ...
          <div className="flex gap-5">
            <Smartphone size={70} className="p-4 border border-blue-300/30 rounded-2xl backdrop-blur-md bg-linear-to-r from-blue-400 via-purple-400 to-pink-400 hover:scale-110 hover:border-blue-300 text-blue-300/50 hover:text-blue-300 "/>
            <Code2 size={32} />
            <Server size={32} />
            <Database size={32} />
          </div>
