...
const Hero = () => {
  return (
    <section
      id="home"
      className="w-full mx-auto max-w-384 px-5 md:px-10 lg:px-15 text-white pt-35 lg:pt-0 lg:min-h-screen flex items-center justify-center"
    >
      <div className="flex flex-col lg:flex-row items-center justify-center gap-7 lg:gap-20 text-center lg:text-start">
        ...
        <Image
          ...
          height={350}
          width={350}
          className="rounded-2xl lg:h-5xl lg:w-5xl"
        />
      </div>
    </section>
  );
