      ...
      >
        ...
        <div className="flex flex-wrap gap-10 justify-center items-start p-10">
          {skillsData.map((skill, index) => (
            <div
              key={index}
              className="hover:rotate-3 hover:scale-105 hover:shadow-xl hover:shadow-orange-200/30 transition-transform duration-300 backdrop-blur-md border-1 bg-white/5 border-white/20 text-white p-5 rounded-3xl flex flex-col justify-center items-center gap-5"
            >
              <Image src={skill.img} className="h-30" alt={skill.title} width={120} height={120} />
