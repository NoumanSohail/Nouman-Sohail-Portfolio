...
const Hero = () => {
  return (
    ...
    >
      {/* Central Glowing Orb */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[50%] h-[50%] bg-indigo-500 rounded-full blur-[120px] opacity-40 animate-pulse [animation-delay:600ms]" />
