  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-10 mt-20 xl:mt-30">
        ...
        {/* Image */}
        <div className="p-5 border border-white/30 bg-white/5 backdrop-blur-xs rounded-3xl">
          <Image
            src={me2}
            alt="Nouman Sohail"
            height={250}
        ...
        {/* Entire Content */}
        <div
          className="flex flex-col items-center justify-center gap-3 w-full p-5 mb-5 border border-white/30 
