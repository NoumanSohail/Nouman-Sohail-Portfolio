  ...
  return (
    ...
    >
      ...
      <div className="absolute -left-15 -top-15 pointer-events-none">
        {/* ✨ Aura (ONLY this pulses) */}
        <div
          className="absolute inset-0 w-44 h-44 xl:w-56 xl:h-56 rounded-full
               bg-white/30 blur-lg animate-pulse [animation-duration:3.5s]"
        />

        {/* 🌕 Moon (NO animation here) */}
        <div
          className="relative w-48 h-48 xl:w-60 xl:h-60 rounded-full
