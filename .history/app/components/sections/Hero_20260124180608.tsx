  ...
  return (
    ...
    >
      <div className="flex flex-col lg:flex-row items-center justify-center gap-7 lg:gap-20 text-center lg:text-start">
        <Code size={50} className="absolute top-[1%] left-[5%] font-black" />
        ...
        />
        <Code2 size={90} className="absolute right-[48%] top-[40%] p-3 rounded-md border border-white/20 backdrop-blur-xs animate-bounce tracking-wider text-transparent bg-clip-text bg-linear-to-r from-blue-400 via-purple-400 to-pink-400" />
      </div>
    </section>
  );
};
