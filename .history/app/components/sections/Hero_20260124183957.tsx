      ...
      <div className="flex flex-col lg:flex-row items-center justify-center gap-7 lg:gap-20 text-center lg:text-start">
        <div className="flex flex-col gap-5">
          ...
          <div className="flex gap-5">
            ...
            <Code2 size={32} className="p-4 border border-blue-300/30 rounded-2xl backdrop-blur-md bg-purple-300/10 hover:scale-110 hover:border-purple-300 text-purple-300/50 hover:text-purple-300 transition-all duration-300"/>
            <Server size={32} />
            <Database size={32} />
          </div>
        </div>
