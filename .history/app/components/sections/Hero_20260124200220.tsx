...
const Hero = () => {
  return (
    <section
      id="home"
      className="relative scroll-mt-40 w-full mx-auto max-w-384
             px-5 md:px-10 lg:px-15
             text-white mt-30 md:mt-40
             min-h-[70vh] overflow-hidden"
    >
      {/* Central Glowing Orb */}
      <div className="absolute w-[35%] h-[35%] bg-indigo-500 rounded-full blur-[120px] opacity-40 animate-pulse [animation-delay:2000ms]" />
      {/* Orbiting Elements */}
      <div className="absolute left-[10%] w-50 h-50 md:w-110 md:h-110 border border-white/5 rounded-full animate-spin [animation-duration:20s]" />
