  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-10 mt-20 xl:mt-30">
        ...
        {/* Entire Content */}
        <div className="flex flex-col items-center justify-center gap-10 w-full pb-10">
          {/* Content */}
          {contactdata.map((contact, index) => (
            ...
            >
              ...
              {/* Contact and Message */}
              <div
                className="flex flex-col border border-white/30 w-full md:w-[60%] lg:w-[50%] bg-white/5 backdrop-blur-xs p-5 gap-5
                         rounded-3xl transition-all duration-300 hover:scale-105 hover:shadow-md hover:shadow-purple-300/40"
              >
                <div className="flex flex-col gap-3">
